...
const JobPostModeration = () => {
    ...
    const confirmAction = async () => {
        ...
        // Validate removal reason if action is remove
        if (modalAction === 'remove' && !removalReason.trim()) {
            alert('Please provide a reason for removing this job post');
            return;
        }
        
        try {
            if (modalAction === 'remove') await adminService.removeJobPost(selectedPost.jobPostId, removalReason);
                                ...
                                {modalAction === 'remove' && (
                                    <div className="mt-3">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Please provide a detailed reason for removing this job post..."
                                            required
                                        />
                                        <small className="form-text text-muted">
                                            This reason will be logged and sent to the employer.
                                        </small>
                                    </div>
                                )}
                            </div>
