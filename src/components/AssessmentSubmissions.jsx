        ...
        <div className="card-body">
          ...
          <div className="row g-3 mb-4">
            ...
            <div className="col-md-3">
              <div className="card bg-warning text-dark">
                <div className="card-body text-center">
                  <h4 className="mb-0">{stats.avgScore}</h4>
          ...
          {filteredSubmissions.length === 0 ? (
            <div className="text-center py-4 text-muted">
              ...
              <p className="mt-2">No submissions found for this filter</p>
            </div>
          ) : (
                        ...
                        {(submission.status === 'Completed' || submission.status === 'Reviewed') && (
                          <div className="btn-group btn-group-sm">
                            ...
                            <button
                              ...
                              onClick={() => handleAddScore(submission)}
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title">
                  ...
                  Responses from {selectedSubmission.jobSeekerName}
                </h5>
                <button 
                  type="button" 
                  className="btn-close" 
              ...
              <div className="modal-body">
                <div className="mb-3">
                  <p className="mb-1"><strong>Status:</strong> {getStatusBadge(selectedSubmission.status)}</p>
                  <p className="mb-1"><strong>Completed:</strong> {new Date(selectedSubmission.completedAt).toLocaleString()}</p>
                  {selectedSubmission.score !== null && selectedSubmission.score !== undefined && (
                    <p className="mb-0">
                      <strong>Score:</strong> 
                      <span className="badge bg-primary ms-2">{selectedSubmission.score}</span>
                    </p>
                  )}
                </div>
                <hr />
                {selectedSubmission.responses && selectedSubmission.responses.length > 0 ? (
                  ...
                  <p className="text-muted">No responses available</p>
                )}
              </div>
