...
/**
 * Place <NotificationsListener onNotification={fn} /> near App root.
 * onNotification(payload) will be called for incoming notifications.
...
export function NotificationsListener({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      off && off();
      // Note: We don't stop the connection here as it might be shared
    };
