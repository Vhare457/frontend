...
const adminService = {
    ...
    removeJobPost: (jobPostId, removalReason) => api.post(`/admin/job-posts/${jobPostId}/remove`, { jobPostId, removalReason }),
    ...
    deactivateUser: (userId, reason) => api.post(`/admin/users/${userId}/deactivate`, { userId, reason }),
